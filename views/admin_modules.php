...
<div class="wrap">
	...
	<h2>
		...
		<a href="http://cubepoints.com/forums/forum/modules-releases/" class="add-new-h2"><?php _e('Get More Modules', 'cubepoints'); ?></a>
	</h2>
	...
	<?php
		...
		$redirUri = remove_query_arg( 'activate', $currUri );
		$redirUri = remove_query_arg( 'deactivate', $currUri );
	...
	<table class="wp-list-table widefat plugins" cellspacing="0">
		...
		<tbody>
			...
			<?php else: ?>
				<?php foreach ( $modulesToDisplay as $module ) : ?>
				<?php
